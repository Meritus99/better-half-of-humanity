...
class Women(models.Model):
	...
	cat = models.ForeignKey('Category', on_delete=models.PROTECT, verbose_name='Category', related_name = 'get_posts') # related_name = 'get_posts' для того чтоб в shell`e использовать .get_posts.all() а не women_set.all()
